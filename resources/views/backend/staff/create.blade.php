            ...
            <div class="box-body">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" name="facebook_url" id="facebook_url" value="{{ old('facebook_url') }}">
                </div>              
                <div class="form-group col-md-12">
                     ...
                     <div class="controls" style="padding-left: 20px">
                        ...
                        <label class="checkbox">
                              ...
                              <input style="opacity: 1" type="checkbox" {{ old('type') == 2 ? "checked=checked" : "" }} value="2" name="type" style="opacity: 0;"></span>
                        ...
                        <label class="checkbox">
                              ...
                              <input  style="opacity: 1" type="checkbox"  {{ old('type_1') == 1 ? "checked=checked" : "" }}  value="1" name="type_1" style="opacity: 0;"></span>
                        ...
                        <label class="checkbox">
                              ...
                              <input  style="opacity: 1" type="checkbox"  {{ old('type_2') == 3 ? "checked=checked" : "" }}  value="3" name="type_2" style="opacity: 0;"></span>
