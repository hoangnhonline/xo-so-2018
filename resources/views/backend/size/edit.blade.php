...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('size.index') }}" style="margin-bottom:5px">Quay lại</a>
    <form role="form" method="POST" action="{{ route('size.update') }}">
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
              ...
              @endif                              
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="chieu_dai" id="chieu_dai" value="{{ old('chieu_dai', $detail->chieu_dai) }}">
                </div>
                 <div class="form-group">
                  <label>Vòng eo <span class="red-star">*</span></label>
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="{{ route('size.index')}}">Hủy</a>
            </div>
