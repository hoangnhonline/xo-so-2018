            ...
            <div class="box-body">
              ...
              @endif               
                ...
                <div class="form-group col-md-6" style="padding-right: 5px !important;">
                  ...
                  <input type="text" class="form-control datepicker" name="ngay_dat" id="ngay_dat" value="{{ old('ngay_dat') }}">
                </div>
                
                 <div class="form-group col-md-6">
                  <label>Tiền cọc <span class="red-star">*</span></label>
                  <input type="text" class="form-control number" name="tien_coc" id="tien_coc" value="{{ old('ngay_dat') }}">
                </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                  ...
                  <div class="radio col-md-4">
                    <label>
                      <input type="radio" name="order_status" id="order_status1" value="1" @if(old('order_status') == 1 || !old('order_status')) checked="checked" @endif>
                      Chưa giao
                    </label>
                  </div>
                  <div class="radio col-md-4">
                    <label>
                      <input type="radio" name="order_status" id="order_status2" value="2" @if(old('order_status') == 2 ) checked="checked" @endif>
                      Đã giao
                    </label>
                  </div>
                  <div class="radio col-md-4">
                    <label>
                      <input type="radio" name="order_status" id="order_status3" value="3" @if(old('order_status') == 3 ) checked="checked" @endif>
                      Khác
                    </label>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="radio col-md-4">
                    <label>
                      <input type="radio" name="da_soan" id="da_soan1" value="1" @if(old('da_soan') == 1 || !old('da_soan')) checked="checked" @endif>
                      Chưa soạn
                    </label>
                  </div>
                  <div class="radio col-md-4">
                    <label>
                      <input type="radio" name="da_soan" id="da_soan2" value="2" @if(old('da_soan') == 2 ) checked="checked" @endif>
                      Đã soạn
                    </label>
                  </div>     
                ...
                <div class="form-group">
                  ...
                  <div class="radio col-md-4">
                    <label>
                      <input type="radio" name="call_status" id="call_status1" value="1"  @if(old('call_status') == 1 || !old('call_status')) checked="checked" @endif>
                      Chưa gọi
                    </label>
                  </div>
                  <div class="radio col-md-4">
                    <label>
                      <input type="radio" name="call_status" id="call_status2" value="2"  @if(old('call_status') == 2 ) checked="checked" @endif>
                      Đã gọi
                    </label>
                  </div>     
                  <div class="radio col-md-4"></div>             
                ...
                <div class="form-group">
                  <div class="checkbox col-md-12" >
                    <label>
                      <input type="checkbox" name="not_form" value="1" id="not_form" {{ old('not_form') == 1 ? "checked" : "" }}>
                      KHÔNG THỬ FORM
                    </label>
                  </div>                 
