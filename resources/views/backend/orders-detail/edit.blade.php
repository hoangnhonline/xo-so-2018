...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Cập nhật sản phẩm ĐH : {{ $orderInfo->customer->name }} - {{ $orderInfo->customer->phone }} [{{$orderInfo->id}}] 
    </h1>
    <ol class="breadcrumb">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="{{ route('orders-detail.update') }}">
    <div class="row">
      <!-- left column -->
            ...
            <div class="box-body">
              ...
              <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="loai_id" id="loai_id">
                        ...
                        {{ old('loai_id', $detail->loai_id) == $loai->id ? "selected" : "" }}                           
                        >{{ $loai->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="product_code" id="product_code" value="{{ old('product_code', $detail->product_code) }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control number" name="number_product" id="number_product" value="{{ old('number_product', $detail->number_product) }}">
                </div>           
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control datepicker" name="ngay_giao" id="ngay_giao" value="{{ old('ngay_giao', date('d-m-Y', strtotime($detail->ngay_giao))) }}">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="mau_id" id="mau_id">
                        ...
                        <option value="{{ $loai->id }}"
                        {{ old('mau_id', $detail->mau_id) == $loai->id ? "selected" : "" }}                           
                        >{{ $loai->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="kieu_id" id="kieu_id">
                        ...
                        <option value="{{ $loai->id }}"
                        {{ old('kieu_id', $detail->kieu_id) == $loai->id ? "selected" : "" }}                           
                        >{{ $loai->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="size_id" id="size_id">
                        ...
                        <option value="{{ $loai->id }}"
                        {{ old('size_id', $detail->size_id) == $loai->id ? "selected" : "" }}                           
                        >{{ $loai->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="form_status_id" id="form_status_id">
                        ...
                        <option value="{{ $loai->id }}"
                        {{ old('form_status_id', $detail->form_status_id) == $loai->id ? "selected" : "" }}                           
                        >{{ $loai->value }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="form_ok_id" id="form_ok_id">
                        ...
                        <option value="{{ $loai->id }}"
                        {{ old('form_ok_id', $detail->form_ok_id) == $loai->id ? "selected" : "" }}                           
                        >{{ $loai->value }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="process" id="process">
                        <option value="1" {{ old('process', $detail->process) == 1 ? 'selected' : '' }}>Chưa làm</option>
                        <option value="2" {{ old('process', $detail->process) == 2 ? 'selected' : '' }}>Đang làm</option>                  
                        <option value="3" {{ old('process', $detail->process) == 3 ? 'selected' : '' }}>Làm xong</option>
                        <option value="4" {{ old('process', $detail->process) == 4 ? 'selected' : '' }}>Đã giao</option>   
                    </select>
                </div>                
              </div>
              <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="nguoi_nhan" id="nguoi_nhan">
                        ...
                        {{ old('nguoi_nhan', $detail->nguoi_nhan) == $staff->id ? "selected" : "" }}                           
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="staff_rap" id="staff_rap">
                        ...
                        <option value="{{ $staff->id }}"
                        {{ old('staff_rap', $detail->staff_rap) == $staff->id ? "selected" : "" }}                           
                        >{{ $staff->short_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="staff_cat" id="staff_cat">
                        ...
                        @foreach( $staffArr as $staff )
                        <option value="{{ $staff->id }}"
                        {{ old('staff_cat', $detail->staff_cat) == $staff->id ? "selected" : "" }}                           
                        >{{ $staff->short_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="staff_may" id="staff_may">
                        ...
                        @foreach( $staffArr as $staff )
                        <option value="{{ $staff->id }}"
                        {{ old('staff_may', $detail->staff_may) == $staff->id ? "selected" : "" }}                           
                        >{{ $staff->short_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="staff_ren" id="staff_ren">
                        ...
                        <option value="{{ $staff->id }}"
                        {{ old('staff_ren', $detail->staff_ren) == $staff->id ? "selected" : "" }}                           
                        >{{ $staff->short_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="staff_cuom" id="staff_cuom">
                        ...
                        @foreach( $staffDinhArr as $staff )
                        <option value="{{ $staff->id }}"
                        {{ old('staff_cuom', $detail->staff_cuom) == $staff->id ? "selected" : "" }}                           
                        >{{ $staff->short_name }}</option>
                        @endforeach  
                    </select>
                </div>                
              ...
              <div class="col-md-5">
                <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-9">
                    <img id="thumbnail_image" src="{{ $detail->image_url ? Helper::showImage($detail->image_url ) : URL::asset('public/assets/dist/img/img.png') }}" class="img-thumbnail" width="150">
              ...
              <div class="col-md-7">
                <div class="form-group">
                  <label>Ghi chú</label>
                  <textarea class="form-control" name="notes" id="notes" rows="5">{{ old('notes', $detail->notes) }}</textarea>
                </div>
              </div>                
            </div>
